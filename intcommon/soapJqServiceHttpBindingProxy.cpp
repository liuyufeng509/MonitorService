...
int JqServiceHttpBindingProxy::getData(const char *endpoint, const char *soap_action, _ns1__getData *ns1__getData, _ns1__getDataResponse *ns1__getDataResponse)
{	struct soap *soap = this;
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns1__getDataResponse->soap_get(soap, "ns1:getDataResponse", NULL);
	if (soap->error)
